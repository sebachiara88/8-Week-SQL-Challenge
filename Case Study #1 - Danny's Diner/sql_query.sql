...
(SELECT
	CUSTOMER_ID,
	JOIN_DATE,
	DATEADD(DAY, 6, JOIN_DATE) AS FIRST_WEEK_END_DAY,
	EOMONTH('2021-01-01') AS END_OF_MONTH
FROM MEMBERS
),
CTE_POINTS AS
(SELECT
	...
	FIRST_WEEK_END_DAY,
	CASE 
		WHEN ORDER_DATE BETWEEN JOIN_DATE AND FIRST_WEEK_END_DAY THEN M.PRICE * 20
